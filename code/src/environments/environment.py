...
Source: https://github.com/FLAIROx/JaxMARL/blob/main/jaxmarl/environments/multi_agent_env.py
"""
...
Observations:TypeAlias = dict[str, chex.Array]
Rewards:TypeAlias = dict[str, float]
Dones:TypeAlias = dict[str,bool]    
