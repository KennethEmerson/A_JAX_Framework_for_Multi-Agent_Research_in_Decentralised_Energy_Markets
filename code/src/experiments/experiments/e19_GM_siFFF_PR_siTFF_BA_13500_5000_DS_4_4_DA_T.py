...
-------------------------------------------------------------------------------------------
global market: constant
prosumers: yearly fluctuations
battery: 13500Wh, peak :5000Wh
Day-ahead window : True
Data sharing: True for first four agents
...
_prosumers = [
    pconf.DummyProsumerConfig(
            ...
            NOISE_AMPLITUDE=0, 
            NOISE_SEED=0 
        ) for agent_id in  expconf.AGENT_ID_LIST[0:2]] + [
    ...
    pconf.DummyProsumerConfig(
            ...
            NOISE_AMPLITUDE=0, 
            NOISE_SEED=0 
        ) for agent_id in  expconf.AGENT_ID_LIST[2:4]] + [
    ...
    pconf.DummyProsumerConfig(
            ...
            NOISE_AMPLITUDE=0, 
            NOISE_SEED=0 
        ) for agent_id in  expconf.AGENT_ID_LIST[4:6]] + [
    ...
    pconf.DummyProsumerConfig(
            ...
            NOISE_AMPLITUDE=0, 
            NOISE_SEED=0 
        ) for agent_id in  expconf.AGENT_ID_LIST[6:8]
...
_multiagent_rule_transformers = {agent_id:tconf.TransformerConfig(
            ...
            WITH_DAY_AHEAD_WINDOW=True, 
            DATA_SHARING_AGENTS=4, 
...
_global_market = gconf.DummyDataGlobalMarketConfig(
        ...
        YEARLY_DAY_AHEAD_PRICE_AMPLITUDE=0,
        DAILY_DAY_AHEAD_PRICE_AMPLTITUDE=0, ######### reset to zero ##########
        NOISE_AMPLITUDE=0,
        NOISE_SEED=0
    ) 
