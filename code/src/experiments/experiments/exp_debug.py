...
-------------------------------------------------------------------------------------------
Experiment DEBUG: used of debugging and testing purposes
...
_global_market = gconf.DummyDataGlobalMarketConfig(
        ...
        DAILY_DAY_AHEAD_PRICE_AMPLTITUDE=0.000005,
        NOISE_AMPLITUDE=0,
        NOISE_SEED=0
    ) 
...
config_rule_agent =[expconf.ExperimentConfig(
    ...
    TAGS=["no batteries","rule_based_agents","4 cte consumers","4 cte producers"],
